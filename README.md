...
- **題材聚焦(AI/衛星等)**:平台把人工智慧、太空衛星科技、電動車輛、區塊鏈等
  前瞻題材也建成獨立產業鏈(`THEME_CHAINS`)。每檔強勢股會標上所屬題材徽章,
  上方「題材聚焦」選單可選一個題材,系統將含該題材強勢股的族群置頂、其餘淡化,
  並把該題材的個股高亮——即可看出「今天在噴的東西有哪些跟 AI / 衛星相關」,
  即使它們散落在半導體、連接器、醫療器材等不同族群。
